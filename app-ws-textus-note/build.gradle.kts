...
android {
    namespace = "com.wangshu.textus.note"
    ...
    signingConfigs {
        create("wsts") {
            storeFile = file("keystore/wsts.jks")
            storePassword = "teal123"
            keyAlias = "teal"
            keyPassword = "teal123"
        }
    }
    ...
    productFlavors {
        ...
        create("wsts") {
            applicationId = "com.wangshu.tael.silver"
            versionCode = 110
            versionName = "1.1.0"
...
dependencies {
    ...
    implementation(project(":ws-mira-sdk"))
